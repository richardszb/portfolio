...
export default function App() {
    return (
        <div className="bg-black text-zinc-400 min-h-screen font-sans selection:bg-cyan-900 selection:text-cyan-50 relative overflow-x-hidden">
                ...
                <div className="lg:flex lg:justify-between lg:gap-4">
                    ...
                    <main className="pt-24 lg:w-1/2 lg:py-24">
                        ...
                        <section id="about" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24 text-zinc-400 leading-relaxed space-y-4">
                            ...
                            <p>
                                Ha szeretné felvenni velem a kapcsolatot, megtalálsz a közösségi platformokon, vagy írhatsz nekem közvetlenül a <a href="mailto:richard@szabo-richard.com" className="font-medium text-zinc-200 hover:text-cyan-400 transition-colors">richard@szabo-richard.com</a> e-mail címre.
                            </p>
                        </section>
                        ...
                        <section id="projects" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
                            ...
                            <div className="space-y-12 group/list">
                                ...
                                <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:opacity-100! lg:group-hover/list:opacity-50">
                                    ...
                                    <div className="z-10 sm:col-span-8">
                                        <h3 className="font-medium leading-tight text-zinc-200 group-hover:text-cyan-400 transition-colors">
                                            {/* IDE ÍRD BE AZ AUTÓPATIKA LINKJÉT A "#" HELYÉRE */}
                                            <a href="https://richardszb.github.io/autopatika-weblap/" target="_blank" rel="noreferrer" className="inline-flex items-baseline font-medium leading-tight text-zinc-200 hover:text-cyan-400 text-base">
                                        ...
                                        <p className="mt-2 text-sm leading-normal text-zinc-400">
                                            Egyedi, letisztult weboldal bemutatkozó felületének felépítése és tartalomformázása tiszta HTML és CSS használatával. A projekt során a cél egy felhasználóbarát, egyértelmű struktúrájú és reszponzív felület megalkotása volt.
                                        </p>
                                        <div className="mt-3 flex flex-wrap gap-2">
                                            <span className="flex items-center rounded-full bg-cyan-950/40 px-3 py-1 text-xs font-medium text-cyan-400 border border-cyan-900/30">HTML</span>
                                            <span className="flex items-center rounded-full bg-cyan-950/40 px-3 py-1 text-xs font-medium text-cyan-400 border border-cyan-900/30">CSS</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <footer className="max-w-md pb-16 text-sm text-zinc-500 sm:pb-0">
                            <p>
                                Kódolva <b className="font-medium text-zinc-400">WebStorm</b>-ban. Építve <b className="font-medium text-zinc-400">React</b>, <b className="font-medium text-zinc-400">Vite</b> és <b className="font-medium text-zinc-400">Tailwind CSS</b> használatával, a háttérben egy egyedi Canvas animációval. A szövegezés letisztult <b className="font-medium text-zinc-400">Inter</b> betűtípust használ. A dizájn alapjait és elrendezését Brittany Chiang portfóliója inspirálta.
                            </p>
                        </footer>
